...
//     end_pending: { label: 'Terminating', color: 'bg-red-500' },
//     provisioning: { label: 'Provisioning', color: 'bg-yellow-500' },
//     offline: { label: 'archived', color: 'bg-gray-500' },
//   };
//   return statusMap[status] || {label: status, color: 'bg-blue-500', dot: 'bg-blue-500' }
// };
							...
							<CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">      
								...
								<div className="grid grid-cols-2 gap-4 text-sm">
									{[
										...
										{ label: 'TotalCost', val: `${instance.totalCost}` }
									].map(item => (
